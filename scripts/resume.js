const resume = {
  ...
  work: [
    ...
    {
      name: "Concept and Color",
      location: "Chicago, IL",
      description: "Awesome color company",
      url: "https://conceptandcolor.com",
      position: "Software Developer",
      startDate: "2021-01-01",
      endDate: "2021-07-01",
      highlights: [
        "Developed and structured responsive client websites",
        "Collaborated with a team across the stack to create feature-rich web applications.",
      ],
    },
    {
